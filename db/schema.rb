...
ActiveRecord::Schema.define(:version => 20100215080848) do
  ...
  create_table "highlight_content_versions", :force => true do |t|
    ...
    t.integer  "attachment_version"
    t.string   "title"
    t.string   "linkurl",              :limit => 200, :default => "",    :null => false
    t.text     "description"
    t.boolean  "published",                           :default => false
    t.boolean  "deleted",                             :default => false
    t.boolean  "archived",                            :default => false
  ...
  create_table "image_list_versions", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "linkurl1",        :limit => 100
    t.string   "linkurl2",        :limit => 100
    t.string   "linkurl3",        :limit => 100
    t.string   "linkurl4",        :limit => 100
  end
  ...
  create_table "news_contents", :force => true do |t|
    ...
    t.date     "date"
    t.string   "title"
    t.string   "linkurl",            :limit => 100, :default => "",    :null => false
    t.text     "description"
    t.boolean  "published",                         :default => false
    t.boolean  "deleted",                           :default => false
    t.boolean  "archived",                          :default => false
